// Booking modal. Triggers (.js-booking-open) are real
// <a href="booking-url" target="_blank"> links in the markup — the
// no-JS baseline is a plain outbound link. This script intercepts the
// click (preventDefault) and opens the modal instead; see
// _includes/booking-modal.html for the "No-JS" note.
(function () {
  'use strict';
  ...
  var load   = modal.querySelector('.booking-modal-loading');
  var closer = modal.querySelector('.booking-modal-close');
  var opener = null;
  ...
  document.querySelectorAll('.js-booking-open').forEach(function (btn) {
